...
elseif($_SESSION['akses'] == 'MASTER' || $_SESSION['akses'] == 'ADMIN'){
?>
<!DOCTYPE html>
<html>
    
    <head>
        <title>BKD Kota Makassar</title>
        <!-- Bootstrap -->
                     ...
                     <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header" style="background:linear-gradient(to top, #f1bb51, #ff8635)">
                                <div class="muted pull-left" style="color:#fff">Jadwal</div>
                            </div>
                            <div style="text-align:right;padding:5px">
                           <a href="?page=spr" class="btn btn-warning">Jadwal</a>
                           <a href="?page=libur"  class="btn btn-warning">Libur</a>
                           </div>
                              ...
                              <div class="block-content">
                                <div class="span12">
                                   ...
                                   switch($feli){
                                    ...
                                    break;
                                    case "spr":
                                        include "config/schedule.php";
                                   break;
                                   case "libur":
                                         include "config/libur.php";
                                    break;
...
<?php
    ...
    echo "<center>Maaaf, Anda tidak Memiliki Hak Untuk Mengakses Halaman ini<br>
        <a href='#' onclick='history.back();'>Kembali</a></center>";
}
?>